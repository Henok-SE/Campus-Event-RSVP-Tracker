...
export default function ProfileSettings() {
  ...
  const handleSave = async () => {
    ...
    if (!isAdmin && formData.interest_categories.length + normalizedCustomInterests.length === 0) {
    ...
    try {
      ...
      if (!isAdmin) {
        payload.interest_categories = formData.interest_categories;
        payload.interest_keywords = normalizedCustomInterests;
      }
        ...
        <div className="space-y-6">
          ...
          {isAdmin ? (
            <div className="rounded-2xl border border-blue-200 bg-blue-50 px-4 py-3 text-sm text-blue-700">
              Interest preferences are optional for admin accounts and are not required here.
            </div>
          ) : (
            <>
              <div>
